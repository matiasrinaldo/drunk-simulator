...
- [ ] 04-01-PLAN.md — Slice ANIM-02: animación por código del HUD (pulso de DrunkBar por EffectIntensity + wobble de MoneyText al rechazar compra) en HUDController + PlayerPickup
...
- [ ] 04-03-PLAN.md — Slice ANIM-01: DoorProximityTrigger (sin cargar escena) + puerta decorativa en City con Animator + verificación Play Mode (checkpoint)
